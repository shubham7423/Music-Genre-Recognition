...
class Trainer:
    ...
    def train (self, train_loader, epoch):
        ...
        train_bar = tq.tqdm_notebook(train_loader, total=len(train_loader), desc=description, position=0, leave=True)
    ...
    def val (self, val_loader, epoch):
        ...
        with torch.no_grad():
            valid_bar = tq.tqdm_notebook(val_loader, total=len(val_loader), desc=description, position=0, leave=True)
